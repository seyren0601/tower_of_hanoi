...
using UnityEngine;
    ...
    public class PriorityQueueDebugView<TElement, TPriority>:MonoBehaviour {
...
public class PriorityQueue<TElement, TPriority> {
    ...
    private void Grow( int minCapacity ) {
        System.Diagnostics.Debug.Assert( _nodes.Length < minCapacity );
    ...
    private void MoveUpDefaultComparer( (TElement Element, TPriority Priority) node, int nodeIndex ) {
        ...
        System.Diagnostics.Debug.Assert( _comparer is null );
        System.Diagnostics.Debug.Assert( 0 <= nodeIndex && nodeIndex < _size );
    ...
    private void MoveUpCustomComparer( (TElement Element, TPriority Priority) node, int nodeIndex ) {
        ...
        System.Diagnostics.Debug.Assert( _comparer is not null );
        System.Diagnostics.Debug.Assert( 0 <= nodeIndex && nodeIndex < _size );
